...
const WomenClothing = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('https://urbanthreadapi.onrender.com/api/clothing-items'); // Replace with your API endpoint
  ...
  const addToCart = async (item) => {
    ...
    try {
      ...
      const response = await fetch('https://urbanthreadapi.onrender.com/api/cart'); // Get all cart items
      ...
      if (existingItem) {
        ...
        await fetch(`https://urbanthreadapi.onrender.com/api/cart/${existingItem.id}`, {
          method: 'PUT',
          headers: {
        ...
        await fetch('https://urbanthreadapi.onrender.com/api/cart', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
